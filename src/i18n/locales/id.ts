...
export const id: Dictionary = {
  ...
  hero: {
    ...
    sub: "ARC hadir dengan server milikmu sendiri. Khusus untukmu, tidak pernah dibagi. Sunday tinggal di sana dan menyelesaikan berbagai hal selagi kamu menjalani harimu.",
