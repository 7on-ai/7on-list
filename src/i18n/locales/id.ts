...
export const id: Dictionary = {
  ...
  invite: {
    ...
    copied: "Tersalin",
    share: "Bagikan",
    shareText: "Sunday tinggal di 7on ARC. Dapatkan spesifikasinya:",
    pageTitle: "Posisimu di antrean",
    place: "Posisimu",
    friends: "Teman yang bergabung",
    how: "Saat 7on ARC siap, kami mengirim email sesuai urutan antrean. Teman dihitung setelah email spesifikasinya sampai.",
