...
export const ja: Dictionary = {
  ...
  hero: {
    ...
    sub: "ARC には、あなた専用のサーバーが付いてきます。誰とも共有しません。Sunday はそこに住み、あなたが毎日を過ごすあいだに、やるべきことを片づけます。",
    placeholder: "メールアドレス",
    cta: "ARC のスペックを受け取る",
  ...
  machine: {
    ...
    points: [
      { title: "ひとりに、ひとつのサーバー。", line: "CPU も RAM もデータベースも専用。誰とも共有しません。" },
      { title: "あなたを特定させない。", line: "処理の前に、名前や番号は取り除かれます。" },
      { title: "時間をさかのぼる記憶。", line: "Sunday がいつ何を覚えていたかを時間軸で確認。追加も編集も、一時的に忘れさせることも、完全に消すこともできます。" },
    ],
    cta: "ARC のスペックを受け取る",
  },
  prefs: {
