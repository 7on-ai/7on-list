...
export const ja: Dictionary = {
  ...
  hero: {
    ...
    sub: "ARC には、あなた専用のプライベートクラウドが付いてきます。コンテナもデータベースも、あなたひとりのため。Sunday はそこに住み、あなたが毎日を過ごすあいだに、やるべきことを片づけます。",
    placeholder: "メールアドレス",
    cta: "ARC のスペックを受け取る",
  ...
  machine: {
    ...
    points: [
      { title: "ひとりに、ひとつのクラウド。", line: "専用のコンテナとデータベース。誰とも共有しません。" },
      { title: "あなたを特定させない。", line: "処理の前に、名前や番号は取り除かれます。" },
      { title: "いつでも消せる。", line: "すべての記憶を確認し、何でも削除できます。" },
    ],
    cta: "ARC のスペックを受け取る",
  },
  prefs: {
