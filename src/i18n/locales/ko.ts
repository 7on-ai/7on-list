...
export const ko: Dictionary = {
  ...
  hero: {
    ...
    sub: "ARC에는 나만의 프라이빗 클라우드가 함께합니다. 컨테이너 하나, 데이터베이스 하나, 오직 한 사람을 위해. Sunday는 그곳에 살며, 당신이 하루를 보내는 동안 일을 끝냅니다.",
    placeholder: "이메일 주소",
    cta: "ARC 스펙 받아보기",
  ...
  machine: {
    ...
    points: [
      { title: "한 사람, 하나의 클라우드.", line: "나만의 컨테이너와 데이터베이스. 절대 공유하지 않습니다." },
      { title: "신원은 남기지 않습니다.", line: "처리 전에 이름과 번호를 모두 지웁니다." },
      { title: "언제든 지울 수 있게.", line: "모든 기억을 확인하고, 무엇이든 삭제하세요." },
    ],
    cta: "ARC 스펙 받아보기",
  },
  prefs: {
